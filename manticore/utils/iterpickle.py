...
class Pickler:
    ...
    def dump(self, obj):
        ...
        # about as fast as it was for simple structures, albeit slower for 
        # large structures.
        callstack = [self.save(obj)]
        while callstack:
            try:
                result = next(callstack[-1])
    ...
    def save(self, obj):
        ...
        yield self.save_reduce(obj=obj, *rv)
    ...
    def save_reduce(self, func, args, state=None,
        ...
        if listitems is not None:
            yield self._batch_appends(listitems)

        if dictitems is not None:
            yield self._batch_setitems(dictitems)
    ...
    def save_list(self, obj):
        ...
        self.memoize(obj)
        yield self._batch_appends(iter(obj))
